    ...
    <div class="w-full max-w-md mx-3">
        ...
        <div class="bg-gray-800 p-8 rounded-lg shadow-lg">
            <div class="flex justify-center mb-6">
                <h2 class="text-2xl font-bold text-white">Fale Conosco</h2>
            </div>
            ...
            <form id="contactForm">
                ...
                <!-- Mensagem -->
                <div class="mb-6">
                    <label for="message" class="block text-sm font-medium text-gray-300 mb-2">Sua Mensagem</label>
                ...
                <div class="flex justify-center mt-6">
                    <button type="button" onclick="generateWhatsAppLink()"
                        class="px-6 py-3 bg-green-600 hover:bg-green-700 text-white font-medium rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-colors flex items-center">
